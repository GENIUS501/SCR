...
namespace SCR
{
    public partial class Visor_Movimientos_Usuario : Form
    {
        public string Usuario { get; set; }
        public string Nombre_Usuario { get; set; }
        public Visor_Movimientos_Usuario()
        {
            InitializeComponent();
        }

        private void Visor_Movimientos_Usuario_Load(object sender, EventArgs e)
        {
            try
            {
